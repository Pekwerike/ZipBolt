...
class PlainVideoFileTransferWaitingLayoutItemViewHolder(
    ...
    companion object {
        fun createViewHolder(parent: ViewGroup): PlainVideoFileTransferWaitingLayoutItemViewHolder {
            ...
            return PlainVideoFileTransferWaitingLayoutItemViewHolder(layoutBinding)
        }
    }
}