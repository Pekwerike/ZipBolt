...
class PlainDocumentFileTransferCompleteLayoutItemViewHolder(
    ...
    companion object {
        fun createViewHolder(parent: ViewGroup): PlainDocumentFileTransferCompleteLayoutItemViewHolder {
            ...
            return PlainDocumentFileTransferCompleteLayoutItemViewHolder(layoutBinding)
        }
    }
}