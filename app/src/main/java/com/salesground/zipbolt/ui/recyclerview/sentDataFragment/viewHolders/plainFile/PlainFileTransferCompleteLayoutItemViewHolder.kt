...
class PlainFileTransferCompleteLayoutItemViewHolder(
    ...
    fun bindData(dataToTransfer: DataToTransfer) {
        plainFileTransferLayoutItemBinding.run {
            ...
            plainFileTransferLayoutItemShimmer.run {
                stopShimmer()
                hideShimmer()
            }
        }
    ...
    companion object {
        fun createViewHolder(parent: ViewGroup): PlainFileTransferCompleteLayoutItemViewHolder {
            ...
            return PlainFileTransferCompleteLayoutItemViewHolder(layoutBinding)
        }
    }
}