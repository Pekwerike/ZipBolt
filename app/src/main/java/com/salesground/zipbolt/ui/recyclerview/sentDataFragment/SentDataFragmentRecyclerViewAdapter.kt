...
class SentDataFragmentRecyclerViewAdapter() : ListAdapter<
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            ...
            SentDataFragmentAdapterViewTypes.PLAIN_DOCUMENT_FILE_TRANSFER_WAITING.value -> {
                PlainDocumentFileTransferWaitingLayoutItemViewHolder.createViewHolder(parent)
            }
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        when (holder) {
            ...
            is PlainDocumentFileTransferCompleteLayoutItemViewHolder -> {
                holder.bindData(dataItem)
            }
